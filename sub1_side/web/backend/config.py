...
# ROS_DOMAIN_ID — main_side(realtime_scan) 와 일치해야 cross-PC ROS2 통신 가능.
# 호스트 ~/.bashrc 가 다른 값을 export 하더라도 app.py 가 startup() 에서
# os.environ 에 강제 주입하므로 이 상수가 단일 출처(single source of truth).
ROS2_DOMAIN_ID     = 24
